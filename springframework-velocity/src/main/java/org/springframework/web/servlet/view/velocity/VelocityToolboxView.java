...
public class VelocityToolboxView extends VelocityView {
	 ...
	 * @see ToolManager#configure(String)
	 */
	...
	protected Context createVelocityContext(
		...
		if (getToolboxConfigLocation() != null) {
			// 这里必须指定 autoConfig=false，指定 true 时，有bug
			ViewToolManager viewToolManager = new ViewToolManager(getServletContext(), false, true);
			...
			return new VelocityContext(model, viewToolContext);
		} else {
